...
export interface ILoremIpsumSenderInterface extends utils.Interface {
  functions: {
...
export interface ILoremIpsumSender extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILoremIpsumSenderInterface;
