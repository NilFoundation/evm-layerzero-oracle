...
export interface ILoremIpsumResonseHandlerInterface extends utils.Interface {
  functions: {
...
export interface ILoremIpsumResonseHandler extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILoremIpsumResonseHandlerInterface;
