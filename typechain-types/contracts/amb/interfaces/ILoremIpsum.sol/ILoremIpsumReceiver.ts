...
export interface ILoremIpsumReceiverInterface extends utils.Interface {
  functions: {
...
export interface ILoremIpsumReceiver extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ILoremIpsumReceiverInterface;
